...
function AppContent() {
  ...
  const transparentNavPaths = ['/i-edicion', '/i-edicion/crisis', '/i-edicion/cia', '/i-edicion/consejo-seguridad', '/i-edicion/investigacion', '/i-edicion/oiea', '/i-edicion/prensa'];
