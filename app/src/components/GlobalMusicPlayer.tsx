...
const COMMITTEE_ROUTES = ['/corte', '/corte/mesa', '/investigacion', '/investigacion/mesa', '/crisis', '/crisis/mesa', '/cia', '/consejo-seguridad', '/consejo-seguridad/mesa', '/oiea', '/prensa', '/banco'];
